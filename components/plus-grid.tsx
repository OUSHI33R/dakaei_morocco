...
export function PlusGridRow({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-x-0 top-0 border-t border-white/80"></div>
        <div className="absolute inset-x-0 top-2 border-t border-white/30"></div>
        <div className="absolute inset-x-0 bottom-0 hidden border-b border-white/80 group-last/row:block"></div>
        <div className="absolute inset-x-0 bottom-2 hidden border-b border-white/30 group-last/row:block"></div>
      </div>
      {children}
    </div>
  );
