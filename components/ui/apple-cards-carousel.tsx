...
export const Carousel = ({ items, initialScroll = 0 }: CarouselProps) => {
  ...
  const [isScrolling, setIsScrolling] = useState(false); // Track whether the user is manually scrolling
    ...
    >
      <div className="relative w-full">
        <div
          ...
          ref={carouselRef}
          onScroll={handleUserScroll} // Detect when the user scrolls
        >
          <div
            className={cn(
          ...
          >
            {items.map((item, index) => (
              <motion.div
                ...
                key={"card" + index}
                className="last:pr-[1%] md:last:pr-[1%] rounded-3xl"
              >
                {item}
              </motion.div>
            ))}
